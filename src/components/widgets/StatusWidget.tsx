...
export default function StatusWidget() {
  return (
    <div className="w-full max-w-[180px] md:max-w-[224px] bg-white border-2 border-black p-3 md:p-4 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[4px] hover:translate-y-[4px] transition-all cursor-default flex flex-col justify-between h-full gravity-element">
