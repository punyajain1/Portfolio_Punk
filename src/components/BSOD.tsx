    ...
    >
      <div className="bg-[#1c1c1c] text-white p-8 md:p-12 rounded-xl shadow-2xl max-w-2xl w-[90%] flex flex-col items-center text-center space-y-8 border border-gray-800 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 md:gap-8">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-gray-200 rounded-full flex items-center justify-center text-black mb-2 shadow-[0_0_20px_rgba(255,255,255,0.1)]">
                <Power size={40} strokeWidth={3} className="md:w-12 md:h-12" />
            </div>
            
            <div className="space-y-4 md:space-y-6 font-medium tracking-wide text-sm md:text-lg leading-relaxed">
                <p>
